...
const userDetails: UserDetails = {
  ...
  description: "I am currently working at Space ya Tech as a Front-end Developer, where I help develop web apps. SYT is an open-source web platform for the youths built with.",
  blogArticles: [
    {
